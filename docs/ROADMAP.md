...
| 阶段 | 目标 | 主要交付物 | 验收门槛 | 状态 |
| --- | --- | --- | --- | --- |
| 0. Fork 与基线 | 保留 upstream 血缘 | `origin=个人 fork`、`upstream=原仓库`、基线 tag | 可执行 upstream MCP smoke | 等待 Fork |
...
| 3. XHS Provider | 接真实小红书 | Adapter、缓存、归一化、预算控制 | 小样本搜索/详情/Creator/评论可重放 | 待开始 |
